...
import ChatInfoModal from '@/components/chat-page/channel/ChatInfoModal';
...
const ChannelButtons = () => {
  ...
  const onClickSettingModal = useCallback(() => {
  ...
  return (
    <div className="relative flex flex-row">
      ...
      <button type="button" className={`hover:bg-sky-700 hover:text-white p-1 ${showSettingModal ? 'bg-sky-700 text-white' : ''}`} onClick={onClickSettingModal}>
        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
